...
public class JPZIO {
    ...
    private static InputStream unzipOrPassthrough(InputStream is) throws IOException{
    	 try {
    ...
    public static boolean convertJPZPuzzle(InputStream is, DataOutputStream os, Date d) {
