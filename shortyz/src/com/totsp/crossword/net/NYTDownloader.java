...
public class NYTDownloader extends AbstractDownloader {
	...
	private HttpClient login() throws IOException {
		 	...
		 	httpclient.getParams().setParameter("User-Agent", "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; en-US; rv:1.9.1.6) Gecko/20091201 Firefox/3.5.6");
	...
	public File download(Date date) {
		...
		//Feb2310.puz
		return this.download(date, MONTHS[date.getMonth()]+
				this.nf.format(date.getDate())+
				this.nf.format(date.getYear() - 100)+
				".puz");
	}
