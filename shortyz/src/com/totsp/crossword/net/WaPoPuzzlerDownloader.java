...
public class WaPoPuzzlerDownloader extends AbstractDownloader {
    ...
    public WaPoPuzzlerDownloader() {
        super("http://crosswords.washingtonpost.com/wp-srv/style/crosswords/util/csserve2.cgi?t=puz&z=puzzler&f=", DOWNLOAD_DIR, NAME);
	...
	protected String createUrlSuffix(Date date) {
		return "cs" + nf.format(date.getYear() - 100) +
